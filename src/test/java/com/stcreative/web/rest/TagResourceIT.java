...
import com.stcreative.domain.Tag;
import com.stcreative.repository.TagRepository;
...
public class TagResourceIT {
    ...
    public void createTag() throws Exception {
        ...
        assertThat(testTag.getTagSlug()).isEqualTo(DEFAULT_TAG_SLUG);
        assertThat(testTag.getTagDescription()).isEqualTo(DEFAULT_TAG_DESCRIPTION);
    }
    ...
    public void getAllTags() throws Exception {
        ...
        restTagMockMvc.perform(get("/api/tags?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].tagDescription").value(hasItem(DEFAULT_TAG_DESCRIPTION.toString())));
    }
    ...
    public void updateTag() throws Exception {
        ...
        assertThat(testTag.getTagSlug()).isEqualTo(UPDATED_TAG_SLUG);
        assertThat(testTag.getTagDescription()).isEqualTo(UPDATED_TAG_DESCRIPTION);
    }
