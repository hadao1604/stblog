...
import com.stcreative.BlogappApp;
import com.stcreative.domain.Media;
import com.stcreative.repository.MediaRepository;
import com.stcreative.web.rest.errors.ExceptionTranslator;
...
import static com.stcreative.web.rest.TestUtil.createFormattingConversionService;
...
public class MediaResourceIT {
    ...
    private static final String DEFAULT_MEDIA_CAPTION = "AAAAAAAAAA";
    private static final String UPDATED_MEDIA_CAPTION = "BBBBBBBBBB";
    ...
    public static Media createUpdatedEntity(EntityManager em) {
        Media media = new Media()
            ...
            .mediaCaption(UPDATED_MEDIA_CAPTION);
        return media;
    }
    ...
    public void createMedia() throws Exception {
        ...
        assertThat(testMedia.getMediaCaption()).isEqualTo(DEFAULT_MEDIA_CAPTION);
    }
    ...
    public void getAllMedia() throws Exception {
        ...
        restMediaMockMvc.perform(get("/api/media?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].mediaCaption").value(hasItem(DEFAULT_MEDIA_CAPTION.toString())));
    }
    ...
    public void getMedia() throws Exception {
        ...
        restMediaMockMvc.perform(get("/api/media/{id}", media.getId()))
            ...
            .andExpect(jsonPath("$.mediaCaption").value(DEFAULT_MEDIA_CAPTION.toString()));
    }
    ...
    public void updateMedia() throws Exception {
        ...
        assertThat(testMedia.getMediaCaption()).isEqualTo(UPDATED_MEDIA_CAPTION);
    }
